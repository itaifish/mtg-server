...
const panelStyle: React.CSSProperties = {
  ...
  border: 'var(--border-width) var(--border-style) var(--color-border)', padding: '24px',
  minWidth: '320px', maxWidth: '90vw', maxHeight: '90vh', overflow: 'auto',
};

export function Modal({ title, onClose, children }: ModalProps) {
  return (
    <div className="modal-overlay" style={overlayStyle} role="dialog" aria-modal="true" aria-label={title} onClick={onClose}>

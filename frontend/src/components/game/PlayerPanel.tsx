...
export function PlayerPanel({ player, isActive }: PlayerPanelProps) {
  return (
    <div className="panel player-panel" style={{ padding: '12px', background: 'var(--color-surface)', borderRadius: 'var(--radius)', border: isActive ? '2px solid var(--color-gold)' : 'var(--border-width) var(--border-style) var(--color-border)' }}>
